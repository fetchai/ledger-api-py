...
class TransactionSerialisation(unittest.TestCase):
    ...
    def test_simple_transfer(self):
        ...
        transaction_bytes = transaction.encode_transaction(payload, [ENTITIES[0]])
    ...
    def assertTxAreEqual(self, reference: Transaction, other: Transaction):
        ...
        self.assertEqual(reference.counter, other.counter)
        self.assertEqual(reference._metadata, other._metadata)
        self.assertEqual(reference.payload, other.payload)
