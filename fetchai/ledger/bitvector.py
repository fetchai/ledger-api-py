...
class BitVector:
    ...
    def from_bytes(data: bytes, bit_size: int):
        ...
        # ensuring the bit size matches expectation
...
@property
    ...
    def get(self, bit: int) -> int:
        """
            Getter function returning a one or a zero dependent on ...?
            
            :param bit: an integer representing a number of bits.
...
def as_binary(self):
    """
        Function to convert this BitVector object as a reversed binary string.
...
def as_hex(self):
    """
        Function to convert this BitVector object into a hexadecimal string.
